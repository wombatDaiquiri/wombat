...
var migrations = []Migration{
	{
		ID: "20240412153400",
		MigrationQuery: `CREATE TABLE blogposts (
			id SERIAL PRIMARY KEY,
			ulid VARCHAR(26) NOT NULL,
			title VARCHAR(255) NOT NULL,
			content_markdown TEXT NOT NULL
		);`,
		RollbackQuery: `DROP TABLE blogposts;`,
	},
	{
		ID: "20240418121500",
		MigrationQuery: `ALTER TABLE blogposts
    		ADD COLUMN created_at TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT NOW(),
    		ADD COLUMN publication_date TIMESTAMP WITH TIME ZONE DEFAULT NULL;`,
		RollbackQuery: `ALTER TABLE blogposts
